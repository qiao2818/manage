...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { address: @info.address, date: @info.date, money: @info.money, user_id: @info.user_id }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { address: @info.address, date: @info.date, money: @info.money, user_id: @info.user_id }
    assert_redirected_to info_path(assigns(:info))
  end
